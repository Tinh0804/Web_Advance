...
class Register extends Component {
  ...
  // ✅ THAY ĐỔI: Không gọi API ngay, mà chuyển sang trang chọn ngôn ngữ
  handleRegister = async (e) => {
    ...
    // ✅ Lưu dữ liệu vào localStorage và chuyển sang trang chọn ngôn ngữ
    const registerData = {
    ...
    // Chuyển sang trang chọn ngôn ngữ học
